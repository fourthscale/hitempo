      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-16 rounded-md bg-secondary text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/50"
          />
          <kbd className="absolute right-3 top-1/2 -translate-y-1/2 px-1.5 py-0.5 text-[10px] font-medium rounded border border-border bg-background text-muted-foreground">
            ⌘ K
          </kbd>
        </div>
      </div>
